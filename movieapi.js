...
function ApiLoaded(data){
  ...
  for (var i = 0; i <= data.length-1; i++){
    ...
    document.querySelector("#row"+i).innerHTML += "<td> <div class='fas fa-star'></div> Rating: " +data[i].vote_average+" <br> <div class='fas fa-users'></div>Voters: "+data[i].vote_count+"<br> <div class='fas fa-thumbs-o-up'></div>Popularity: "+data[i].popularity+"</td>";
